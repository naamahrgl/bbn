...
const translations = {
  ...
  en: {
    ...
    hero_slogan: 'Sourdough gluten-free breads and pastries, baked with love.',
    ...
    <div className="relative bg-brand-primary">
      <div className="container mx-auto px-4 py-16 sm:py-20 md:py-28">
        <div className="max-w-2xl text-center md:text-start">
          <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-brand-dark">
            {t('hero_title')}
          </h1>
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 text-brand-light">
            {t('hero_slogan')}
          </p>
          <div className="mt-6 sm:mt-10">
            <Button className="bg-brand-secondary hover:bg-[#703c31] text-white shadow-lg">
  ...
  return (
    <div className="bg-brand-background py-12 sm:py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-center font-serif text-2xl sm:text-3xl font-bold tracking-tight text-brand-dark">
          {t('featuredFavorites')}
        </h2>
